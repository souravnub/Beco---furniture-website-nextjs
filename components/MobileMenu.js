        ...
        <ul
            ...
            {links.map(({ href, text }) => {
                return (
                    <div
                        key={href}
                        className="group relative isolate border-b border-t border-dark-fade p-5 after:absolute after:inset-0 after:-z-10 after:origin-top after:scale-y-0 after:bg-white after:transition-transform after:duration-300 after:content-['']  focus-within:after:scale-y-100 hover:after:scale-y-100">
            ...
            <Link
                href={"/contact"}
                className="group mt-14 ml-5  grid aspect-square w-fit grid-flow-col place-content-center items-center gap-3 rounded-full bg-brand p-5 text-black">
